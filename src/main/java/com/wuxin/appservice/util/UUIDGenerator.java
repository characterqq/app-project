...
public class UUIDGenerator {
    ...
    public static String ARRIVAITEM = "【资产到货】";
    ...
    public static Long getMilesLong(){
    ...
    public static Long unique2milesLong(Long l){
    	return new Long((l-new Long(addrBytes[3] & 0x0FF))/1000);
    }
}