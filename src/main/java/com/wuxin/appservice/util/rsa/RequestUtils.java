...
public class RequestUtils {
    ...
    public static String doPost(String url, String param) {
        ...
        try {
            ...
            out = new PrintWriter(new OutputStreamWriter(conn.getOutputStream(), RsaConfig.serverEncodeType));
            // 发送请求参数
            out.print(param);
            // flush输出流的缓冲
            out.flush();
            // 定义BufferedReader输入流来读取URL的响应
            in = new BufferedReader(new InputStreamReader(conn.getInputStream(), RsaConfig.serverEncodeType));
            String line;
