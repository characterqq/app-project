...
<div id="container" class="effect aside-float aside-bright mainnav-lg">
	...
	<div class="boxed">
		...
		<div id="content-container">
			<div id="page-title">
					<a href="#"> <i
							class="demo-psi-home"></i> <span class="menu-title"> <strong>用户管理</strong>
						</span>
					</a>
				   <i class="ion-chevron-right"></i><a href="#"><span class="menu-title"> <strong>用户</strong>
						</span>
					</a>
			</div>
               <div id="page-content">
				<div class="panel">
				    ...
				    <div class="panel-body" >
				    	<form id="queryForm" action="" method="post" class="">
							...
							<div class="col-md-2">
								<div class="form-group" >
									<select id="roleIds" style="width: 100%" >
									</select>
								</div>
							</div>
			...
			<p>
				<form class="form-horizontal " id="form" method="post">
					...
					<div class="form-group ">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="userName" name="userName" onchange="isName(this)" >
						</div>
					</div>
					<div class="form-group ">
					...
					<div class="form-group  ">
						<label for="name" class="col-sm-3 control-label text-main">角色<span class="text-danger"> *</span></label>
						<div class="col-sm-8">
					...
					$.each(list,function(i, item){
						if(item.status==0){
 						...
 						$("#user-table").append("<tr  >"
								...
								+"<button  style='margin-right:3px' id='update' type='button'class='btn btn-info btn-xs' data-toggle='tooltip'title='修改'onclick='get("+item.uid+")'>"
								+"修改"
								+"</button>"
								+bon +"</td>"
